...
urlpatterns = [
    ...
    path('register/',
         views.CustomRegistrationView.as_view(template_name='django_registration/registration_form.html'),
    ...
    path('password_reset/',
         views.CustomPasswordResetView.as_view(template_name='users/password_reset_form.html'),
         name='password_reset'),
